...
\textbf{Oczekiwany rezultat:} Pomyślne logowanie i~odszyfrowanie klucza E2E. Użytkownik uzyskuje dostęp do~aplikacji bez konieczności ponownej konfiguracji zabezpieczeń.
...
\begin{table}[H]
	...
	\begin{tabular}{p{1cm} p{7cm} p{2cm} p{3cm}}
		...
		WF4         & Pobieranie i uruchamianie testów lokalnie & Tak                & Scenariusze 1, 5 \\
