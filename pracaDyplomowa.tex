...
% Gdy dodasz plik .bib, użyj:
% \printbibliography[heading=none]

% Tymczasowa lista (ręczna):
\begin{enumerate}
  \item % TODO: Pozycja bibliograficzna 1
  \item % TODO: Pozycja bibliograficzna 2
  \item % TODO: Pozycja bibliograficzna 3
  \item % TODO: ...
\end{enumerate}
...
\begin{description}[style=nextline, labelwidth=3cm, leftmargin=3.5cm]
  \item[API]    Application Programming Interface — interfejs programowania aplikacji
  \item[CRUD]   Create, Read, Update, Delete — podstawowe operacje na danych
  \item[CSS]    Cascading Style Sheets — kaskadowe arkusze stylów
  \item[E2EE]   End-to-End Encryption — szyfrowanie od końca do końca
  \item[GDPR]   General Data Protection Regulation — ogólne rozporządzenie o~ochronie danych
  \item[HTML]   HyperText Markup Language — hipertekstowy język znaczników
  \item[IPC]    Inter-Process Communication — komunikacja międzyprocesowa
  \item[JS]     JavaScript
  \item[NoSQL]  Not Only SQL — nierelacyjna baza danych
  \item[RBAC]   Role-Based Access Control — kontrola dostępu oparta na rolach
  \item[RODO]   Rozporządzenie o~Ochronie Danych Osobowych
  \item[SDK]    Software Development Kit — zestaw narzędzi programistycznych
  \item[UI]     User Interface — interfejs użytkownika
  \item[UX]     User Experience — doświadczenie użytkownika
\end{description}
...
\chapter{Karta pracy dyplomowej}
\label{app:karta}

% Wklejenie skanu karty pracy dyplomowej:
% \includepdf[pages=-]{kartaPracyDyplomowej.pdf}

% TODO: Wstawić skan karty pracy dyplomowej


\chapter{Instrukcja uruchomienia systemu}
\label{app:instrukcja}

% TODO: Krok po kroku jak uruchomić aplikację:
% 1. Wymagania systemowe
% 2. Instalacja zależności
% 3. Konfiguracja Firebase
% 4. Uruchomienie aplikacji
% 5. Pierwszy login / rejestracja


\chapter{Zrzuty ekranu}
\label{app:screeny}

% TODO: Zrzuty ekranu aplikacji z opisami.
